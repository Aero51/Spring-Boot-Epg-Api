...
public class InitialLoadApplicationRunner implements ApplicationRunner {
	...
	private boolean isExcluded(String channel) {
		...
		return !channel.equals("hrt5") && !channel.equals("pinkextra") && !channel.equals("ducktv")
				...
				&& !channel.equals("prvakick") && !channel.equals("nova.rs") && !channel.equals("kcn1")
				&& !channel.equals("studiob") && !channel.equals("nova.rs") && !channel.equals("kcn1")
				&& !channel.equals("novipazar") && !channel.equals("palmaplus") && !channel.equals("srpskanaucna")
				&& !channel.equals("soskanal") && !channel.equals("rtcgSat") && !channel.equals("pink3")
				&& !channel.equals("pinkbravo") && !channel.equals("pinkkoncert") && !channel.equals("sporttv1")
				&& !channel.equals("sporttv2") && !channel.equals("sporttv3") && !channel.equals("sk4.rs")
				&& !channel.equals("sk5.rs") && !channel.equals("sk9.rs") && !channel.equals("sk8.rs")
				&& !channel.equals("sk7.rs")
